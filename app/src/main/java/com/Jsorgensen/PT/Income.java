...
public class Income extends Activity implements OnClickListener, OnFocusChangeListener
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		dt.addAll(Arrays.asList("NAME", "DUE", "DATE", "TIME", "RATE", "TRVL", "TOTAL", "PAID", "NOTES"));
		clmn = dt.size();
		nm = dt.indexOf("NAME");
		tm = dt.indexOf("TIME");
		da = dt.indexOf("DATE");
	...
	public void calc(List<EditText> etc){
		...
		try{
			...
			tot = drt*dtm/60.; // + dtl*0.067 + dtl*1.5*drt/60.;
	...
	//@Override
	public void clear(){
		AlertDialog.Builder alert = new AlertDialog.Builder(Income.this);
